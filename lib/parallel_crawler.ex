defmodule ParallelCrawler do
  ...
  # Indica a função responsável por iniciar o disparo dos processos a serem executados de forma assincrona
  @process_function_2 &Mediator.process/2
  @process_function_3 &Mediator.process/3
  ...
  """
  def run_1x1() do
    Web.AllRecipes.get_smoothies_recipe(@process_function_2)
  end
  ...
  def run_1x1_monitor() do
    :timer.tc(fn -> Web.AllRecipes.get_smoothies_recipe(@process_function_2) end)
  end
  ...
  def run_pool(pool_count) do
    Web.AllRecipes.get_smoothies_recipe(pool_count, @process_function_3)
  end
